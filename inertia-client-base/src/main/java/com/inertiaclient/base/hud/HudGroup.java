...
public class HudGroup implements LanguageBaseKey, JsonState {
    ...
    public void renderGroup(GuiGraphicsExtractor graphics, float mouseX, float mouseY, float tickDelta, boolean editor, CanvasWrapper canvas) {
        canvas.save();
        ...
        for (int i = 0; i < this.enabledComponents.size(); i++) {
            ...
            canvas.translate(xTranslate, yTranslate);
            component.render(graphics, editor, canvas);
