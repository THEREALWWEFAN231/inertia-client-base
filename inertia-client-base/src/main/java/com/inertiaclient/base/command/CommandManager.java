...
public class CommandManager {
    ...
    @Getter
    private ClientSuggestionProvider commandSource = new ClientSuggestionProvider(null, InertiaBase.mc, null);
    @Getter
    ...
    private void registerCommand(Command command) {
        ...
        LiteralArgumentBuilder<ClientSuggestionProvider> builder = command.literal(command.getName(), command.getDescription());
        command.buildArguments(builder);
        LiteralCommandNode<ClientSuggestionProvider> mainCommand = this.dispatcher.register(builder);
        ...
        if (command.getAliases() != null) {
            for (String alias : command.getAliases()) {
                ...
                LiteralArgumentBuilder<ClientSuggestionProvider> aliasBuilder = LiteralArgumentBuilder.literal(alias);
