...
public class ToggleCommand extends Command {
    ...
    public int alloff(CommandContext<ClientSuggestionProvider> context) {
    ...
    public int setState(CommandContext<ClientSuggestionProvider> context, Boolean state) throws CommandSyntaxException {
